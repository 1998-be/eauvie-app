...
def predict_potable(vals):
    feat={}
   Un rf,features=ALL_MODELS['potable']
    for f in features:
...
# ══════════════════════════════════════════════════════════════
st.markdown("### 💧 EauVie — Analyse intelligente de la qualité de l'eau Proposée MEDEZOUNDJI Charles,afin de garantir une utilisation rassurante de l'eau à la maison,dans l'environnement,dans l'agriculture et autres")
